		...
		<div>
			...
			<Container maxWidth='xs'>
				<div className={styles.wrapper}>
					...
					<button className={styles.blue} onClick={operatorHandler} value='/'>
						/
					</button>
					...
					<button className={styles.blue} onClick={operatorHandler} value='X'>
						X
					</button>
					...
					<button className={styles.zero} onClick={inputNum} value={0}>
						0
					</button>
					<button className={styles.gray} onClick={inputNum} value={'.'}>
						,
					</button>
					<button className={styles.blue} onClick={calculate}>
						=
					</button>
				</div>
			</Container>
